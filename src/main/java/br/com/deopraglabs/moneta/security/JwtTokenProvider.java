package br.com.deopraglabs.moneta.security;

import br.com.deopraglabs.moneta.exceptions.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    public TokenResponse createAccessToken(String username, List<String> roles) {
        ...
        return new TokenResponse(username, true, now, expiration, accessToken, refreshToken);
    }
